...
Private team marketplace for reusable ELAD Codex plugins.

## Included plugins

- `elad-dynamics-ado-orchestrator`: Azure DevOps to Dataverse delivery workflow for Dynamics 365 projects. Created by Achia Kellerman.
